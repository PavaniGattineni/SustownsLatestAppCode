...
public class OrderModel {
    ...
    private String pay_fax;
    private String pay_fname;
    private String pay_lname;
    ...
    public String getPay_fax() {
        return pay_fax;
    }

    public void setPay_fax(String pay_fax) {
        this.pay_fax = pay_fax;
    }

    public String getPay_fname() {
        return pay_fname;
    }

    public void setPay_fname(String pay_fname) {
        this.pay_fname = pay_fname;
    }

    public String getPay_lname() {
        return pay_lname;
    }

    public void setPay_lname(String pay_lname) {
    ...
    public String getPay_city() {
        return pay_city;
    }

    public void setPay_city(String pay_city) {
        this.pay_city = pay_city;
    }

    public String getPay_country() {
        return pay_country;
    }

    public void setPay_country(String pay_country) {
